    ...
    useEffect(() => {
        const obtenerUsuarios = async () => {
            try {
                ...
                //setUsuario(response.data); // Guardar los departamentos en el estado
            } catch (error) {
        ...
        <form className="form-container">
            <div className="form-wrapper">
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="inputDepartamento" placeholder="Ingresa el departamento aquí" value={departamento} onChange={(e) => setDepartamento(e.target.value)} />
                </div>
                <div className="mb-3">
                    <label htmlFor="inputJefe" className="form-label">Jefe</label>
                    <input type="text" className="form-control" id="inputJefe" placeholder="Ingresa el jefe aquí" value={jefe} onChange={(e) => setJefe(e.target.value)} />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input type="password" className="form-control" id="inputContrasenia" placeholder="Ingresa la contraseña aquí" value={contrasenia} onChange={(e) => setContrasenia(e.target.value)} />
                </div>
